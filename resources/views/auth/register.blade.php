				...
				<div class="row">
					<div class="col-lg-7">
                        <form method="POST" action="{{ route('register') }}" id="register-form">
                            ...
                            <div class="form-group row mb-4">
                                <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('lang.phone') }}</label>
                            ...
                            <div class="form-group row mb-4">
                                <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('lang.address') }}</label>
